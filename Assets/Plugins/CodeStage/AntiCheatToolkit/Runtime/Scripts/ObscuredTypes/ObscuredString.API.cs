...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	public sealed partial class ObscuredString : IEquatable<ObscuredString>, IEquatable<string>, IComparable<ObscuredString>, IComparable<string>, IComparable
	{
		...
		/// <summary>
		/// GC-free alternative to <c>string.IsNullOrEmpty</c> for <c>ObscuredString</c>.
		/// </summary>
		public static bool IsNullOrEmpty(ObscuredString value)
		{
			return (object)value == null || value.IsDefault() || value.hiddenChars == null || value.hiddenChars.Length == 0;
		}

		/// <summary>
		/// GC-free alternative to <c>string.IsNullOrWhiteSpace</c> for <c>ObscuredString</c>.
		/// Crypto-related operations are implemented in the main class file.
		/// </summary>
		public static bool IsNullOrWhiteSpace(ObscuredString value)
		{
			return IsNullOrWhiteSpaceInternal(value);
		}
